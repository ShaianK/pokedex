                ...
                fetch(moves[i]["move"]["url"]).then(res=>{
                    if (res.status === 200){
                        ...
                        res.json().then(data=>{
                            ...
                            var move_div = `
                            <div class="move move_${move["type"]["name"]}">
                                <div class="row">
                            ...
                            /*
                            var move_div = '<div id="move">\
                            <div class="row">\
                                <div class="col" id="moveType">\
                                    type:\
                                </div>\
                                <div class="col" id="movePP">\
                                    pp\
                                </div>\
                            </div>\
                            <div class="row" id="moveName">\
                                name\
                            </div>\
                            <div class="row">\
                                <div class="col" id="moveACC">\
                                    acc\
                                </div>\
                                <div class="col" id="movePOW">\
                                    pow\
                                </div>\
                            </div>\
                            </div>'
